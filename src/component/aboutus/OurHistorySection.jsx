        ...
        <Container maxWidth="lg" sx={{ paddingBlock: "80px" }}>
          ...
          <Box className="flex " sx={{ gap: "80px" }}>
            <Box className="flex gap-4" width={"50%"} sx={{ zIndex: "1" }}>
              <Box>
                <img
                  src="src/assets/ourhistorysection/about-us-11.jpg"
                  alt=""
                  width={280}
                  height={280}
              ...
              <Box>
                <img
                  src="src/assets/ourhistorysection/about-us-12.jpg"
                  alt=""
                  width={280}
                  height={280}
                  className="firstaboutimg"
            ...
            <Box width={"50%"}>
              ...
              >
                ...
                dui. Curabitur aliquet quam id dui posuere blandit. Vestibulum
