...
const NicestthingsSection=()=>{
    return(
        ...
        <Container maxWidth="lg">
           ...
           <Box className="flex flex-col gap-y-4 p-6 nicestcontent1" width={"33%" } sx={{boxShadow:"3"}}>
            ...
            <Box className="flex flex-col gap-y-4 p-6 shadow-2xl nicestcontent1" width={"33%" } sx={{boxShadow:"4"}}>
                <Typography className="flex justify-center" >
            ...
            <Box className="flex flex-col gap-y-4 p-6 shadow-2xl nicestcontent1" width={"33%" } sx={{boxShadow:"3"}}>
                <Typography className="flex justify-center" >
