...
const ContractorsSection = () => {
  return (
    <>
      <Container
        className="contractionsection"
        maxWidth="lg"
        sx={{ marginTop: "130px", position: "relative" }}
      >
        <Box
          className="flex justify-between gap-9 contractionsection"
          sx={{ paddingBottom: "180px" }}
        >
          <Box
