...
const BusinessSection=()=>{
    return(
        ...
        <div>
             ...
             <Container className="flex justify-between mt-7 mb-7 businesscontent" maxWidth="lg">
             ...
             <Box className="flex items-center gap-x-4 border-l-2 justify-center businesscontent1" sx={{width:"30%"}}>
                <Box>
                <Typography>
