...
<Box className="herosectioncontent w-100 " sx={{marginBottom:"50px"}}>
    ...
    <Container  maxwidth="xl">
        <Box sx={{width:"100%", display:"flex",flexDirection:"column", gap:"30px",paddingBlock:"17em"}}>
        ...
        <Box className="w-full flex justify-between p-9 rounded-lg MuiBox-root align center herotextfiled" sx={{bgcolor:"#ffffff",boxShadow:"3", position:"relative", top:"57px"}}>
            <Box>
